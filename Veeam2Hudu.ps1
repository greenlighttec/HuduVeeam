...
'header_top' = Fix-HTMLStyling -htmlOutput $bodyTop
'summary_protect' = Fix-HTMLStyling -htmlOutput $bodySummaryProtect
'summary_backup' = Fix-HTMLStyling -htmlOutput $bodySummaryBK
'summary_replica' = Fix-HTMLStyling -htmlOutput $bodySummaryRp
'summary_backupcopy' = Fix-HTMLStyling -htmlOutput $bodySummaryBc
'summary_tape' = Fix-HTMLStyling -htmlOutput $bodySummaryTp
'summary_ep' = Fix-HTMLStyling -htmlOutput $bodySummaryEp
'summary_surebackup' = Fix-HTMLStyling -htmlOutput $bodySummarySb
'detail_information' = Fix-HTMLStyling -htmlOutput $htmlOutput
